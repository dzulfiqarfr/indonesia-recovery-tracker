...
if (file.exists("data/ier_unemployed_cleaned.csv") == F) {
  ...
  message("The number of unemployed people dataset has been exported")
  
} else if (nrow(unemp_ppl_trf) != nrow(read_csv("data/ier_unemployed_cleaned.csv"))) {
  
  write_csv(unemp_ppl_trf, "data/ier_unemployed_cleaned.csv")
  
  message("The number of unemployed people dataset has been updated")
  
} else {
  
  message("The number of unemployed people dataset is up to date")
