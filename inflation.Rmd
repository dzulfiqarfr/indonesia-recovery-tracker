...
The monthly `r ier_compare_inf(inf_mom_latest$rate_mom[2])` rate was recorded at **`r inf_mom_latest$rate_mom[2]`** percent in `r format(inf_mom_latest$date[2], "%B")`, `r ier_compare_high(inf_mom_latest$rate_mom[2], inf_mom_latest$rate_mom[1])` than the rate in the same month in the previous year.
...
On an annual basis, the `r ier_compare_inf(inf_yoy_latest$rate_yoy[2])` rate stood at **`r inf_yoy_latest$rate_yoy[2]`** percent in `r format(inf_yoy_latest$date[2], "%B")`, `r ier_compare_high(inf_yoy_latest$rate_yoy[2], inf_yoy_latest$rate_yoy[1])` than the rate in the same month a year earlier.
