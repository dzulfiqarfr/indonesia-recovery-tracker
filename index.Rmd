...
div(
  h4(strong("Uptick amid recession")),
...
div(
  h4(strong("Rebound in consumer optimism")),
...
div(
  ...
  bscols(
    widths = c(6, 6),
    div(
      h5("Number of cumulative tests", br("(in million)")),
      test_plot
    ),
    div(
