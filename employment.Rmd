...
```{r script: overall pandemic-hit workers}
...
```{r script: pandemic-hit workers by gender, layout="l-body-outset"}
reactable_phw_sex
```
...
```{r script: pandemic-hit workers by area, layout="l-body-outset"}
reactable_phw_area
```
